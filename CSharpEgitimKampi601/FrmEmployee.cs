...
namespace CSharpEgitimKampi601
{
    public partial class FrmEmployee : Form
    {
        ...
        string connectionString = "Server=localhost;port=5432;Database=CustomerDb;User Id=postgres;Password=YOUR_PASSWORD_HERE";
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Ekleme İşelemi Başarılı");
            connection.Close();
            EmployeeList();
        }
    }
